  ...
  return (
    <div className="lg:flex justify-center items-center w-full gap-20 lg:px-28 px-12 lg:py-10 py-5">
      <div className="lg:w-1/2 w-full">
        ...
        <h2 className="lg:text-2xl md:text-xl text-md font-semibold text-black lg:my-4 my-2">
        ...
        <div className="flex lg:gap-20 gap-10 lg:mt-6 mt-4">
          <div>
            <h3 className="text-[#fd3d57] lg:text-4xl text-2xl font-semibold">
              12
            </h3>
      ...
      <div className="lg:w-1/2 w-full lg:mt-0 mt-6">
        <img
          ...
          src="https://i.ibb.co/svCdNqG/about-img.jpg"
          alt="history image"
        />
      </div>
    </div>
