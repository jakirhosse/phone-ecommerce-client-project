    ...
    <div className="bg-[#f3f3f3] px-12">
      <div className="lg:flex w-full justify-center items-center overflow-hidden">
        ...
        <div data-aos="fade-up" className="lg:w-1/2 w-full lg:py-0 p-4">
          ...
          <p className="my-3 lg:text-[16px] text-[12px] text-justify">
            Shopping fastly and easily more with our app. Get a link to download
            the app on your phone . Samsung Galaxy A37 is a mid-range smartphone
            designed to offer a blend of performance, features, and
            affordability.
          </p>
          <div className="flex w-full items-center mb-6">
            <Input
              className="border lg:w-96 w-full p-4 border-[#fd3d57]"
              type="email"
              placeholder="Email Address..."
            />
            <Button className="bg-[#fd3d57] py-4" type="submit">
              Subscribe
            </Button>
          </div>
