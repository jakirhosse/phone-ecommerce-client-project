...
import { useGetProductQuery } from '@/components/redux/features/topProducts/topProductsApi';
    ...
    <div>
      ...
      <div className="flex justify-center items-center gap-10 mx-10">
        <div className="w-1/2">
          ...
          <img
            className="w-full h-[500px] mx-auto hover:scale-110 duration-300 delay-300 transition-all ease-in-out cursor-pointer"
            src={`${product?.image}`}
            alt={`${product?.title}`}
          />
        </div>
        <div className="w-1/2">
          ...
          <div>
            <button
              ...
              className="py-1 px-4 rounded-[10px] bg-white border border-[#fd3d57] text-[#fd3d57] hover:text-white hover:bg-[#fd3d57] transition ease-in-out duration-300 text-md font-semibold"
            >
              Add To Cart
            </button>
          </div>
