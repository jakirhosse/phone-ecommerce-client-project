...
const internalStorages = ['32GB', '64GB', '128GB', '256GB', '512GB', '1TB'];
const chipsets = [
  'Snapdragon',
  'MediaTek',
  'Exynos',
    ...
    <div className="flex gap-10 m-10">
      <div className="w-1/5">
        ...
        <Accordion type="single" collapsible className="w-full mt-10">
          <AccordionItem
            value="item-1"
            className="border-2 px-3 rounded-lg my-4"
          >
          ...
          <AccordionItem
            value="item-5"
            className="border-2 px-3 rounded-lg mt-4"
          >
            <AccordionTrigger className="text-md font-semibold">
              Region
            </AccordionTrigger>
      ...
      <div className="w-4/5 grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-6">
        {data?.data?.map((product: any) => {
          ...
          return (
            <div
              key={product._id}
              className="w-52 h-80 border rounded-lg shadow-md"
            >
              <img
              ...
              <div className="text-center px-2 pb-4">
                ...
                <div className="flex justify-between items-center mx-6 mt-2">
                  ...
                  <button
                    ...
                    disabled={isInCart}
                    className={`rounded-full border-2 text-[#fd3d57] py-1 px-1 transition-all ease-in-out duration-700 ${
                      isInCart
