  ...
  return (
    <div className="lg:flex w-full lg:p-12 p-10">
      <div className="lg:w-2/4 w-full mx-auto border-2 rounded-lg p-5 shadow-lg">
        <h4 className="lg:text-xl text-md font-bold lg:my-2 my-1">
          LEAVE US A MESSAGE
        </h4>
        ...
        <form
          className="lg:mt-6 md:mt-4 mt-3"
        ...
        >
          ...
          <div className="my-4">
            <label className="text-md font-bold" htmlFor="email">
              Email Address : <span className="text-md text-[#fd3d57]">*</span>
            </label>{' '}
            <br />
            <input
              className="w-full text-sm border-2 hover:border-[#fd3d57] rounded-md py-1 px-2 "
          ...
          <div className="my-4">
            <label className="text-md font-bold" htmlFor="address">
              Street Address : <span className="text-md text-[#fd3d57]">*</span>
            </label>{' '}
            <br />
            <input
              className="w-full text-sm border-2 hover:border-[#fd3d57] rounded-md py-1 px-2 "
          ...
          <button
            className="lg:text-md text-sm font-bold mt-6 bg-[#fd3d57] text-white py-2 px-4 rounded-lg hover:border-2 hover:bg-white hover:text-[#fd3d57] hover:border-[#fd3d57] transition-all duration-300 ease-in-out "
            type="submit"
          >
            Send Message
          </button>
      ...
      <div className="lg:w-1/4 w-full mx-auto border-2 rounded-lg p-5 shadow-lg lg:mt-0 mt-8">
        ...
        <div>
          <p className="flex items-center lg:gap-3 gap-2 lg:my-3 my-2">
            <span>
              <FaMapMarkerAlt />
            </span>
            Dhaka, BanglaDesh
        ...
        <h4 className="lg:text-xl text-md font-bold lg:my-5 md:my-3 my-2">
          HOURS OF OPERATION
        </h4>
        <div>
          <p className="flex items-center justify-between">
            <span>Satarday</span>10:00
          </p>
          <p className="flex items-center justify-between">
            <span>Sunday</span>10:00
          </p>
          <p className="flex items-center justify-between">
            <span>Monday</span>10:00
          </p>
          <p className="flex items-center justify-between">
            <span>Tuesday</span>10:00
          </p>
          <p className="flex items-center justify-between">
            <span>Thursday</span>10:00
          </p>
          <p className="flex items-center justify-between">
            <span>Wednesday</span>10:00
          </p>
          <p className="flex items-center justify-between">
            <span>Firday</span>10:00
          </p>
        </div>
        <h4 className="lg:text-xl text-md font-bold lg:my-5 md:my-3 my-2">
          CAREERS
        ...
        <p>
          ...
          email us : jakirhossain@gmail.com
        </p>
      </div>
    </div>
  );
